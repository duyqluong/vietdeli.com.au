...
<body>
            ...
            <div class="feature">
                ...
                <div class="hours-container">
                    ...
                    <div class="hours-grid">
                        ...
                        <div class="time">11am - 3pm & 5pm - 8pm</div>
                        
                        <div class="day">Saturday - Sunday</div>
                        <div class="time">11am - 3pm & 5pm - 8pm</div>
                    </div>
                    <p class="delivery-note">All dishes are prepared fresh throughout the day. Come early for the best selection of our full menu!</p>
                </div>
                <a href="menu" class="feature-link">View Our Full Vietnamese Menu</a>
            </div>
        </section>
    ...
    <dialog id="menu-dialog" class="menu-lightbox">
      <img src="images/menu-viet-deli.jpg" alt="Viet Deli's Authentic Vietnamese Menu in Perth">
      <button onclick="document.getElementById('menu-dialog').close()">&times;</button>
    </dialog>
